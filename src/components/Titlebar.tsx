...
const AnimatedLogoTitleBar = () => {
  ...
  return (
    <div className="w-full py-6 md:py-10 flex flex-col items-center relative bg-black overflow-hidden">
      ...
      <style jsx>{`
        ...
        .fade-overlay-left {
          background: linear-gradient(to right, #000 10%, rgba(0, 0, 0, 0.85) 40%, rgba(2, 6, 21, 0.5) 70%, rgba(2, 6, 21, 0));
        }
        
        .fade-overlay-right {
          background: linear-gradient(to left, #000 10%, rgba(0, 0, 0, 0.85) 40%, rgba(2, 6, 21, 0.5) 70%, rgba(2, 6, 21, 0));
        }
      `}</style>
    </div>
  );
